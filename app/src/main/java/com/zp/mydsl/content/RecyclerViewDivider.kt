...
class RecyclerViewDivider: RecyclerView.ItemDecoration {
    ...
    companion object {
        ...
        /** 默认 颜色不是很突出的 左右边距的分割线 分割线 */
        fun getDefaultDivider(context: Context) =
                RecyclerViewDivider(context, HORIZONTAL, R.dimen.default_divider_height, R.color.line_color, R.dimen.default_divider_padding, R.dimen.default_divider_padding)
    }
